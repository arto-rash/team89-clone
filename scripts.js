...
function nextPrevSlide(np) {
    document.getElementById("image"+current).classList.remove('active');
    current=(current+np+3)%3;
    document.getElementById("image"+current).classList.add('active');
}